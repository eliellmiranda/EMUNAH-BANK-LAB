...
//* conteudo corrente em ARQ.BKP.REJEITOS.GDG(+1) e recria o
//* arquivo vazio, evitando crescimento indefinido causado
//* pelas gravacoes diarias do EBJVALD.
//*
//* FLUXO ESPERADO:
//* 1. ARCHREJ  - IEBGENER copia REJEITOS.SEQ -> ARQ.BKP.REJEITOS.GDG(+1).
...
//*
//* === STEP 1: ARQUIVAR REJEITOS.SEQ EM ARQ.BKP.REJEITOS.GDG(+1) ===
//*
