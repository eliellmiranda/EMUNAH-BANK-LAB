...
//* HOST / PDS   : ELIEL.EMUNAH.DEV.JCL(EBBUILD)
//*
//* FINALIDADE:
...
//*   Para compilar outro programa: substituir EBPOST01 pelo
//*   nome do programa desejado em SYSIN e SYSLMOD.
//*
//CL       EXEC IGYWCL
//COBOL.SYSIN   DD DSN=ELIEL.EMUNAH.DEV.COBOL(EBPOST01),DISP=SHR
...
//LKED.SYSLMOD  DD DSN=ELIEL.EMUNAH.DEV.LOADLIB(EBPOST01),DISP=SHR
