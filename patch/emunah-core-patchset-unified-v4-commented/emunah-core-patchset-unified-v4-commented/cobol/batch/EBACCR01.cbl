      *===============================================================*
      * ARQUIVO   : EBACCR01.cbl                                       *
      * CAMINHO   : cobol/batch/EBACCR01.cbl                           *
      *---------------------------------------------------------------*
      * FINALIDADE: Calcular e aplicar accruals diários de juros e tarifas.*
      *                                                               *
      * ENTRADAS  : PARMLIB, CONTA, LANCTO, AUDIT                  *
      * SAIDAS    : CONTA atualizada, ACCROUT, LANCTO, AUDIT       *
      *                                                               *
      * REGRAS / COMPORTAMENTO ESPERADO:                              *
      * - Aplica juros conforme tipo e saldo.                        *
      * - Aplica tarifa quando configurada.                          *
      * - Gera movimentos adicionais entre EOTI e snapshot.          *
      *                                                               *
      * NOTA DIDATICA:                                                *
