//EBCNTDBJ JOB (ACCT),'CARGA CONTAS',CLASS=A,MSGCLASS=X,
//             NOTIFY=&SYSUID,REGION=0M
//*--------------------------------------------------------------*
//* PRECOMPILE + COMPILE + LINK + BIND + RUN
//* PROGRAMA : EBCNTDB1
//* FUNCAO   : CARGA CONTA.KSDS -> EMUNAH.CDCNT
//*--------------------------------------------------------------*
//PRECOMP EXEC PGM=DSNHPC,
//         PARM='HOST(IBMCOB),APOST,SOURCE'
//STEPLIB DD DSN=DB2V13.SDSNLOAD,DISP=SHR
//DBRMLIB DD DSN=ELIEL.EMUNAH.DBRMLIB(EBCNTDB1),DISP=OLD
...
//SYSIN   DD DSN=ELIEL.EMUNAH.DEV.COBOL(EBCNTDB1),DISP=SHR
//*
...
//         DD DDNAME=SYSIN
//SYSLMOD DD DSN=ELIEL.EMUNAH.DEV.LOADLIB(EBCNTDB1),DISP=OLD
//SYSPRINT DD SYSOUT=*
//SYSUT1 DD UNIT=SYSDA,SPACE=(TRK,(5,5))
//SYSIN DD *
...
//CNTVSAM DD DSN=ELIEL.EMUNAH.ARQ.CONTA.KSDS,DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT DD SYSOUT=*
//SYSUDUMP DD SYSOUT=*
//SYSTSIN DD *
  DSN SYSTEM(DBD1)
  RUN PROGRAM(EBCNTDB1) PLAN(EBCNTDB1)
  END
/*
