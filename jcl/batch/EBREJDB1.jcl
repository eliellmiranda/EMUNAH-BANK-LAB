//EBREJDBJ JOB (ACCT),'CARGA REJEITOS',CLASS=A,MSGCLASS=X,
//             NOTIFY=&SYSUID,REGION=0M
//*--------------------------------------------------------------*
//* PRECOMPILE + COMPILE + LINK + BIND + RUN
//* PROGRAMA : EBREJDB1
//* FUNCAO   : CARGA REJEITOS.SEQ -> EMUNAH.CDREJ
//*--------------------------------------------------------------*
//PRECOMP EXEC PGM=DSNHPC,
//         PARM='HOST(IBMCOB),APOST,SOURCE'
//STEPLIB DD DSN=DB2V13.SDSNLOAD,DISP=SHR
//DBRMLIB DD DSN=ELIEL.EMUNAH.DBRMLIB(EBREJDB1),DISP=OLD
...
//SYSIN   DD DSN=ELIEL.EMUNAH.DEV.COBOL(EBREJDB1),DISP=SHR
//*
...
//         DD DDNAME=SYSIN
//SYSLMOD DD DSN=ELIEL.EMUNAH.DEV.LOADLIB(EBREJDB1),DISP=OLD
//SYSPRINT DD SYSOUT=*
//SYSUT1 DD UNIT=SYSDA,SPACE=(TRK,(5,5))
//SYSIN DD *
...
//REJSEQ  DD DSN=ELIEL.EMUNAH.ARQ.REJEITOS.SEQ,DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
...
//SYSTSIN DD *
  DSN SYSTEM(DBD1)
  RUN PROGRAM(EBREJDB1) PLAN(EBREJDB1)
  END
/*
