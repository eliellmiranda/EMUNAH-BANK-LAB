...
//* HOST / PDS   : Z77948.EMUNAH.DEV.JCL(EBALLALL)
//*
//* FINALIDADE:
//*   Bootstrap completo do laboratorio EMUNAH BANK.
//*   Cria do zero TODOS os datasets sob Z77948.EMUNAH.*:
...
//SYSIN    DD *
  ...
  DEFINE CLUSTER ( -
    ...
    VOLUMES(ZXPL01) -
    SHAREOPTIONS(2 3) ) -
    DATA  (NAME(Z77948.EMUNAH.ARQ.CLIENTE.KSDS.DATA)) -
    INDEX (NAME(Z77948.EMUNAH.ARQ.CLIENTE.KSDS.INDEX))
/*
//*
...
//SYSIN    DD *
  ...
  DEFINE CLUSTER ( -
    ...
    VOLUMES(ZXPC02) -
    SHAREOPTIONS(2 3) ) -
    DATA  (NAME(Z77948.EMUNAH.ARQ.CONTA.KSDS.DATA)) -
    INDEX (NAME(Z77948.EMUNAH.ARQ.CONTA.KSDS.INDEX))
/*
//*
...
//SYSIN    DD *
  ...
  DEFINE CLUSTER ( -
    ...
    VOLUMES(ZXPL01) -
    SHAREOPTIONS(2 3) ) -
    DATA (NAME(Z77948.EMUNAH.ARQ.LANCTO.ESDS.DATA))
/*
//*
//* ============================================================
//* === BLOCO 2: GDG BASES ======================================
...
//SYSIN    DD *
  ...
  SET MAXCC = 0
  DEFINE GDG (NAME(Z77948.EMUNAH.ARQ.EXTRATO.GDG)  LIMIT(5) SCRATCH NOEMPTY)
  DEFINE GDG (NAME(Z77948.EMUNAH.ARQ.SALDO.GDG)    LIMIT(5) SCRATCH NOEMPTY)
  DEFINE GDG (NAME(Z77948.EMUNAH.BKP.AUDIT.GDG)    LIMIT(5) SCRATCH NOEMPTY)
  DEFINE GDG (NAME(Z77948.EMUNAH.BKP.CLIENTE.GDG)  LIMIT(5) SCRATCH NOEMPTY)
  DEFINE GDG (NAME(Z77948.EMUNAH.BKP.CONTA.GDG)    LIMIT(5) SCRATCH NOEMPTY)
  DEFINE GDG (NAME(Z77948.EMUNAH.BKP.REJEITOS.GDG) LIMIT(5) SCRATCH NOEMPTY)
/*
//*
//* ============================================================
...
//DEVCOB   DD DSN=Z77948.EMUNAH.DEV.COBOL,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(10,5,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//DEVCPY   DD DSN=Z77948.EMUNAH.DEV.COPY,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(6,3,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//DEVDCL   DD DSN=Z77948.EMUNAH.DEV.DCLGEN,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(3,2,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//DEVJCL   DD DSN=Z77948.EMUNAH.DEV.JCL,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(8,4,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//DEVMAP   DD DSN=Z77948.EMUNAH.DEV.MAPLIB,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(3,2,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//DEVRXX   DD DSN=Z77948.EMUNAH.DEV.REXX,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(6,3,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//HMLCOB   DD DSN=Z77948.EMUNAH.HML.COBOL,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(6,3,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//HMLJCL   DD DSN=Z77948.EMUNAH.HML.JCL,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(6,3,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//PRDJCL   DD DSN=Z77948.EMUNAH.PRD.JCL,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(6,3,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//PRDPRM   DD DSN=Z77948.EMUNAH.PRD.PARMLIB,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(6,3,0)),
//             DSNTYPE=LIBRARY,
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
...
//CONCBAK  DD DSN=Z77948.EMUNAH.ARQ.CONCIL.SEQBCKP,
//             DISP=(NEW,CATLG,DELETE),
...
//ENTTRL   DD DSN=Z77948.EMUNAH.ARQ.ENTRADA.TRAILER.SEQ,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(1,1)),
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
...
//             UNIT=SYSDA,SPACE=(TRK,(5,2)),
//             DCB=(RECFM=FB,LRECL=100,BLKSIZE=0)
//REPRLAN  DD DSN=Z77948.EMUNAH.ARQ.REPR.LANCTO.SEQ,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(5,2)),
//             DCB=(RECFM=FB,LRECL=120,BLKSIZE=0)
//SYSPRINT DD SYSOUT=*
...
//             UNIT=SYSDA,SPACE=(TRK,(5,2)),
//             DCB=(RECFM=FB,LRECL=120,BLKSIZE=0)
//BAKCNT   DD DSN=Z77948.EMUNAH.BAK.CONTA.SEQ,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(TRK,(5,2)),
