...
CREATE TABLE CONTAS (
    ...
    CNT_LIMIT         DECIMAL(11,2)   NOT NULL WITH DEFAULT 0,
    CONSTRAINT PK_CONTAS PRIMARY KEY (CNT_AGENCIA, CNT_NUM_CONTA),
    CONSTRAINT FK_CONTAS_CLI FOREIGN KEY (CNT_ID_CLIENTE) 
...
CREATE TABLE LANCAMENTOS (
    ...
    CONSTRAINT FK_LCT_CONTAS FOREIGN KEY (LCT_AGENCIA, LCT_NUM_CONTA) 
        REFERENCES CONTAS (CNT_AGENCIA, CNT_NUM_CONTA),
...
CREATE TABLE EXTRATO (
    ...
    CONSTRAINT FK_EXT_CONTAS FOREIGN KEY (EXT_AGENCIA, EXT_NUM_CONTA) 
        REFERENCES CONTAS (CNT_AGENCIA, CNT_NUM_CONTA)
);

-- TABELA 5: REJEITOS
CREATE TABLE REJEITOS (
