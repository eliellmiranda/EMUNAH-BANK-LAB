      ...
      *          REGISTROS NA TABELA DB2 ELIEL.CLIENTES          *
      *                                                            *
      ...
      *----------------------------------------------------------*
       ...
       2100-LER-CLIENTE.
           ...
           IF NOT FIM-VSAM
               IF CLI-ID-CLIENTE = ZEROS OR CLI-DATA-NASC = ZEROS
                   DISPLAY 'REGISTRO SEED/INVALIDO IGNORADO. ID='
                           CLI-ID-CLIENTE
                   PERFORM 2100-LER-CLIENTE
               END-IF
           END-IF.
      ...
      *    CONVERTE AAAAMMDD (VSAM) PARA AAAA-MM-DD (DB2 DATE)
       ...
       2300-INSERIR-CLIENTE-DB2.
           ...
           EVALUATE SQLCODE
               ...
               DISPLAY 'ERRO SQL NO INSERT. SQLCODE=' WS-SQLCODE-ED
                       ' CLIENTE=' HV-CLI-ID-CLIENTE
