//EBAUDDBJ JOB (ACCT),'CARGA AUDITORIA',CLASS=A,MSGCLASS=X,
//             NOTIFY=&SYSUID,REGION=0M
//*--------------------------------------------------------------*
//* PRECOMPILE + COMPILE + LINK + BIND + RUN
//* PROGRAMA : EBAUDDB1
//* FUNCAO   : CARGA AUDIT.SEQ -> EMUNAH.CDAUD
//*--------------------------------------------------------------*
//PRECOMP EXEC PGM=DSNHPC,
//         PARM='HOST(IBMCOB),APOST,SOURCE'
//STEPLIB DD DSN=DB2V13.SDSNLOAD,DISP=SHR
//DBRMLIB DD DSN=ELIEL.EMUNAH.DBRMLIB(EBAUDDB1),DISP=OLD
...
//SYSIN   DD DSN=ELIEL.EMUNAH.DEV.COBOL(EBAUDDB1),DISP=SHR
//*
...
//         DD DDNAME=SYSIN
//SYSLMOD DD DSN=ELIEL.EMUNAH.DEV.LOADLIB(EBAUDDB1),DISP=OLD
//SYSPRINT DD SYSOUT=*
//SYSUT1 DD UNIT=SYSDA,SPACE=(TRK,(5,5))
//SYSIN DD *
...
//AUDSEQ  DD DSN=ELIEL.EMUNAH.ARQ.AUDIT.SEQ,DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
...
//SYSTSIN DD *
  DSN SYSTEM(DBD1)
  RUN PROGRAM(EBAUDDB1) PLAN(EBAUDDB1)
  END
/*
