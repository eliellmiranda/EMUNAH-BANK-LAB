...
### Campos numéricos
- valores monetários: `PIC S9(13)V99 COMP-3` (15 dígitos com 2 decimais, compactado)
...
### Campos de data
- formato interno: `PIC X(10)` no padrão `AAAA-MM-DD`
- timestamp: `PIC X(26)` no padrão `AAAA-MM-DD-HH.MM.SS.FFFFFF`
