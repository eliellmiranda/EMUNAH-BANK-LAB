      ...
      *                                                               *
      * ENTRADAS:                                                     *
      *   MOVTIN   = ELIEL.EMUNAH.ARQ.LANCTO.ESDS  (lancamentos val) *
      *   CONTA    = ELIEL.EMUNAH.ARQ.CONTA.KSDS   (master contas)   *
      *                                                               *
      * SAIDAS:                                                       *
      *   CONTA    = ELIEL.EMUNAH.ARQ.CONTA.KSDS   (saldo atualizado)*
      *   REJEITOS = ELIEL.EMUNAH.ARQ.REJEITO.SEQ  (rejeitos negocio)*
